...
| `icdo32_execution/` | Unpacked from `archive/icdo32_execution.zip`: full run, including batches, results, audits, scripts and `SKILL.md` |
| `icdo32_pipeline/` | Unpacked from `archive/icdo32_pipeline.zip`: the reusable pipeline scripts and `SKILL.md` |

The original zip files are kept unchanged in `archive/`.
